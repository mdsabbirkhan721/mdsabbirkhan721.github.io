...
const TShirt = () => {
  ...
  const filteredProducts =
    active === '*'
      ? tshirtProducts
      : tshirtProducts.filter((p) => p.type === active);
  ...
  return (
    <section className="shirt py-5">
      <div className="text-center ">
        <h1>
          T-Shirt<span className="text-primary"> Collection</span>
        </h1>
      ...
      <div className="container py-5">
        <div className="text-center mb-4">
          ...
          <button
            className={`btn me-2 ${
              active === 'plain' ? 'btn-primary' : 'btn-outline-primary'
            }`}
            onClick={() => setActive('plain')}
          >
            Plain T-Shirt
          </button>
