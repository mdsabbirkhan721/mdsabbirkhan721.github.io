...
const Punjabi = () => {
  ...
  const punjabiProducts = products.filter((p) => p.category === 'punjabi');

  const filteredProducts =
    active === '*'
      ? punjabiProducts
      : punjabiProducts.filter((p) => p.type === active);
  ...
  return (
    <section className="shirt py-5">
      <div className="text-center ">
        <h1>
          Punjabi<span className="text-primary"> Collection</span>
        </h1>
      ...
      <div className="container py-5">
        <div className="text-center mb-4">
          ...
          <button
            className={`btn me-2 ${
              active === 'casual' ? 'btn-primary' : 'btn-outline-primary'
            }`}
          ...
          <button
            className={`btn me-2 ${
              active === 'wedding' ? 'btn-primary' : 'btn-outline-primary'
            }`}
          ...
          <button
            className={`btn ${
              active === 'premium' ? 'btn-primary' : 'btn-outline-primary'
            }`}
